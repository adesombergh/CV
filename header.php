	...
	<nav class="navbar navbar-default navbar-fixed-top">
	  <div class="container">
        <div class="navbar-header">
					...
					<a class="navbar-brand visible-xs" href="#"><img alt="Brand" src="assets/images/deba.png" height="56"></a>
	    </div>
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav" id="menu">
	        ...
	        <li data-menuanchor="section6"><a href="#section6">Hobbies</a></li>
	        <li data-menuanchor="section7"><a href="#section7">Contact</a></li>
	      </ul>
	    </div><!-- /.navbar-collapse -->
